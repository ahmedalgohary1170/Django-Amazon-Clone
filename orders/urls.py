...
from .api import OrderListAPI,OrderDatailAPI,ApplyCouponAPI,CreateOrderAPI,CartCreateUpdateDelete
...
urlpatterns = [
    ...
    path('api/<str:username>/orders/<int:pk>',OrderDatailAPI.as_view()),
